            ...
            <div class="card b-0">
                ...
                <fieldset class="show">
					...
					<table class="table table-sm" cellspacing="0"> 
						<tr>
						<td colspan="2"><center><strong><font size="4"><br>Solicitação de Vaga</font></strong></center></td>
						...
						<tr>
						<td>Unidade: <input class="form-control" type="text" id="unidade" name="unidade" value="<?php echo $unidade[0]->sigla; ?>" title="<?php echo $unidade[0]->nome; ?>" readonly="true" /></td>
						...
						<td>Solicitante: <input readonly="true" class="form-control" type="text" id="solicitante" name="solicitante" required value="<?php echo $vaga->solicitante; ?>" title="<?php echo $vaga->solicitante; ?>" /></td>
						</tr>
						<tr>
						...
						<td>Data Prevista: <input class="form-control" readonly="true" type="text" id="data_prevista" name="data_prevista" required value="<?php echo date('d-m-Y', strtotime($vaga->data_prevista)); ?>" title="<?php echo date('d-m-Y', strtotime($vaga->data_prevista)); ?>" /></td>
						</tr>
					</table>
					</center>
					@endforeach
