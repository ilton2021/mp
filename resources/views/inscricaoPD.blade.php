            ...
            <?php $qtdVagas = sizeof($vagas); ?>
              ...
              <tr>
				...
				@foreach($inscricao as $vaga)
                 ...
                 <td> <p><center> <a href="{{ route('inscricaoAprovarPDs', array($vaga->id,$vaga->vaga_interna_id)) }}" class="btn btn-info btn-sm">APROVAR</a> </center></p></td>
                @endforeach
               @endif
               </tr>
          </table>
