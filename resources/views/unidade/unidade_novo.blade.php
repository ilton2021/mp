					...
					<form action="{{\Request::route('storeUnidade')}}" method="post" enctype="multipart/form-data">
					 <input type="hidden" name="_token" value="{{ csrf_token() }}">
						<table border="0" class="table table-bordered" style="line-height: 1.5;" >
						 ...
						 <tr>
							<td colspan="2"><h5 class="sub-heading">NOVA UNIDADE:<br></h5></td>
						 </tr>
						 <tr>
						 ...
						 <tr>
						   ...
						   <td> 
						     <input class="form-control" style="width: 400px" type="text" id="sigla" name="sigla" required value="{{ old('sigla') }}" />
						   </td>
						 </tr>
                         <tr>
						  <td align="right" colspan="2"> <br> <a href="{{ route('cadastroUnidade') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a> 
						   <input type="submit" class="btn btn-success btn-sm" style="margin-top: 10px;" value="SALVAR" id="Salvar" name="Salvar" /> </td>
						 </tr>
						</table>
						<table>
							<tr>
								<td> <input hidden type="text" id="acao" name="acao" value="cadastrar_nova_unidade" class="form-control" /> </td>
