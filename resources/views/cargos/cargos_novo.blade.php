    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-5 col-lg-6 col-md-7">
            <div class="card b-0">
                <fieldset class="show">
                    <div class="form-card">
					<form action="{{\Request::route('storeCargo')}}" method="post">
					 <input type="hidden" name="_token" value="{{ csrf_token() }}">
						<table class="table table-bordered">
						 ...
						 <tr>
						    <td colspan="2" height="20px"><h5 class="sub-heading">NOVO CARGO:</h5></td>
						 </tr>
						 <tr>
							<td> NOME: </td>
							<td>
							<input class="form-control" style="width: 400px" type="text" id="nome" name="nome" required value="" />
							</td>
						 </tr>
						 <tr>
						...
						<table>
						 <tr>
						    <td> <input hidden type="text" id="acao" name="acao" value="cadastrar_novo_cargo" class="form-control" /> </td>
