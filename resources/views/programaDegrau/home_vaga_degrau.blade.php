          ...
          <div class="form-card">
		   <center>
		    <table class="table table-bordered"> 
			 <tr>
			    @if($a == 0)
				 <td><center><strong><br>Vaga PD validada com Sucesso!!!</strong></center></td>
				@else
				 <td><center><strong><br>Vaga PD criada com Sucesso!!!</strong></center></td>
				@endif
			 ...
			 <tr>
			  <td>
			   Exportar PDF:
			   <a class="text-danger" href="{{ route('degrauPDF', array($idG, $idVI)) }}" title="Download PDF Vaga"><img src="{{asset('img/pdf.png')}}" alt="" width="50"></a>
			  </td>
			 </tr>
		    </table>
		    <table class="table table-bordered" style="height: 10px;" cellspacing="0">
		     <tr>
         	   @if($a == 0)
			 	<td align="right"> <a href="{{ route('validarPD') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a> </td>
			   @else
