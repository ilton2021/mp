    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-5 col-lg-6 col-md-7">
            <div class="card b-0">
                ...
                <fieldset class="show">
                    <div class="form-card">
					<form action="{{\Request::route('destroyCargo')}}" method="post">
					 <input type="hidden" name="_token" value="{{ csrf_token() }}">
						<table class="table table-bordered">
						 ...
						 <tr>
						    <td colspan="2" height="20px"><h5 class="sub-heading">EXCLUIR CARGO:</h5></td>
						 </tr>
						 <tr>
							<td> NOME: </td>
							<td>
							  <input class="form-control" style="width: 400px" type="text" id="nome" name="nome" style="width: 200px;" readonly="true" value="<?php echo $cargos[0]->nome; ?>" />
							</td>
						 </tr>
						 <tr>
							<td colspan="2" align="right"> <a href="{{ route('cadastroCargo') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-bottom:30px;margin-top: 5px;color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a>
						...
						<table>
						 <tr>
						    <td> <input hidden type="text" id="acao" name="acao" value="excluir_cargos" class="form-control" /> </td>
