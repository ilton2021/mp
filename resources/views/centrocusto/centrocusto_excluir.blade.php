    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-5 col-lg-6 col-md-7">
            <div class="card b-0">
                ...
                <fieldset class="show">
                    <div class="form-card">
					<form action="{{\Request::route('destroyCentrocusto')}}" method="post">
					 <input type="hidden" name="_token" value="{{ csrf_token() }}">
						<table class="table table-sm">
						 ...
						 <tr>
						    <td colspan="2"><h5 class="sub-heading">EXCLUIR CENTRO DE CUSTO:</h5></td>
						 </tr>
						 <tr>
							<td> <br>Nome: </td>
							<td>
							  <br><input class="form-control" type="text" id="nome" name="nome" readonly="true" style="width: 500px;" value="<?php echo $centrocustos[0]->nome; ?>" />
							</td>
						 </tr>
                         <tr>
                           <td colspan="2"> <br><br>
                         ...
                         <tr>
						  <td colspan="2" align="right"> <a href="{{ route('cadastroCentrocusto') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a>
