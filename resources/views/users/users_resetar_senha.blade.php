                ...
                <fieldset class="show">
					...
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<table class="table table-sm"> 
						  <tr>
						    <td colspan="2" height="20px"><h5 class="sub-heading">ALTERAR SENHA:</h5></td>
						  </tr>
						  <tr>
							<td align="right" style="width: 250px">NOME:</td>
							<td> <input type="text" id="name" name="name" class="form-control form-control-sm" readonly="true" value="<?php echo $users[0]->name; ?>" /> </td>
						  </tr>
						  <tr>
							<td align="right">E-MAIL:</td>
							<td> <input type="text" id="email" name="email" class="form-control form-control-sm" readonly="true" value="<?php echo $users[0]->email; ?>" /> </td>
						  </tr>
						  <tr>
							<td align="right">NOVA SENHA:</td>
							<td> <input type="password" id="password" name="password" required class="form-control form-control-sm" value="{{ old('password') }}" /> </td>
						  </tr>
						  <tr>
							<td align="right">CONFIRMAR NOVA SENHA:</td>
							<td> <input type="password" id="password_confirmation" required name="password_confirmation" class="form-control form-control-sm" value="{{ old('password') }}" /> </td>	
						  </tr>
						  <tr>
