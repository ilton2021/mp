                    ...
                    <div class="form-card">
						...
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						 <table class="table" border="0">
						  ...
						  <tr>
							<td colspan="2"><h5 class="sub-heading">CADASTRO DOS USUÁRIOS:</h5></td>
							<td>
						...
						<tr>
							<td style="font-size: 15px;" colspan="3">{{$user->name}}</td>
							<td>
							  <center>
								<a class="btn btn-info btn-sm" href="{{route('cadastroUsuarioAlterar', $user->id)}}" ><i class="fas fa-edit"></i></a>
								<a class="btn btn-danger btn-sm" href="{{route('cadastroUsuarioExcluir', $user->id)}}" ><i class="fas fa-times-circle"></i></a>
							  </center>
							</td>
						</tr>
						@endforeach
						...
						<table>
							<tr>
							<td> {{ $users->appends(['pesq' => isset($pesq) ? $pesq : '','pesq2' => isset($pesq2) ? $pesq2 : ''])->links() }} </td>
							</tr> 
						</table>
                    </div>
                </fieldset> 
