...
<head>
  ...
  <title>Movimentação de Pessoal - Aprovar Vaga PD</title>
					...
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
						...
						<table class="table table-bordered"> 
							...
							@if($gestor->id == $inscricao[0]->solicitante)
								<td>Solicitante: <input readonly class="form-control form-control-sm" type="text" id="solicitante_" name="solicitante_" required value="<?php echo $gestor->nome; ?>" /></td>
							@endif
							@endforeach	
							</tr>
							<tr>
							...
							<td>Gestor Imediato: <input readonly class="form-control form-control-sm" type="text" id="gestor" name="gestor" required value="CAMILA FERNANDES" /></td>
							</tr>
							<tr>
						...
						<table class="table table-bordered" style="height: 10px;">
							...
							<tr>
							 <td> Nome: <input readonly type="text" name="nome_funcionario" id="nome_funcionario" class="form-control form-control-sm" value="<?php echo $inscricao[0]->nome_funcionario; ?>" /> </td>
							 <td> Matrícula: <input readonly type="text" name="matricula_funcionario" id="matricula_funcionario" class="form-control form-control-sm" value="<?php echo $inscricao[0]->matricula_funcionario; ?>" /> </td>
							 <td> Unidade: <input readonly type="text" name="unidade_funcionario" id="unidade_funcionario" class="form-control form-control-sm" value="<?php echo $inscricao[0]->unidade_funcionario; ?>" /> </td>
							</tr>		
						</table>	
						</center>
						...
						<tr>
							...
							@if($pd[0]->gestor_id == Auth::user()->id || Auth::user()->id == 30)
