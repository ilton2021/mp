...
<head>
  ...
  <script type="text/javascript">
		...
		function somarSalarios(){
			s1 = Number(document.getElementById("salario").value.replace(",",".",2));
			s2 = Number(document.getElementById("outras_verbas").value.replace(",",".",2));
			soma = Number(s1 + s2);
					...
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					  ...
					  <center>
					   <table class="table table-bordered table-sm" style="height: 10px;">
						<tr>  
						 <td> 
						  <center><b><font size="2">IMPACTO FINANCEIRO:</b>
					   ...
					   <table class="table table-bordered table-sm">
						<tr>
						 ...
						 <td>
						  ...
						  <input class="form-control form-control-sm" placeholder="ex: 2500 ou 2580,21" step="00.01" type="number" readonly id="remuneracao_total" name="remuneracao_total" value="{{ old('remuneracao_total') }}" />
						 </td>
						  ...
						  <select class="form-control form-control-sm" id="horario_trabalho" name="horario_trabalho" required onchange="ativarOutra('sim')">
						   ...
						   <font size="2"><b>Outro:</b></font>
							 @if(old('horario_trabalho') == "0")
							  <input class="form-control form-control-sm" type="text" id="horario_trabalho2" name="horario_trabalho2" value="{{ old('horario_trabalho2') }}" placeholder="Horário de Trabalho (Outro):" />	
							 @else
							  <input disabled class="form-control form-control-sm" type="text" id="horario_trabalho2" name="horario_trabalho2" value="{{ old('horario_trabalho2') }}" required placeholder="Horário de Trabalho (Outro):"/>	
							 @endif
						 </td>
						</tr>
						<tr>
						 <td><b><font size="2">Escala de Trabalho:</font></b><br>
						  ...
						  <br> 
							...
							@else
							 <input type="text" disabled id="escala_trabalho6" name="escala_trabalho6" class="form-control form-control-sm" value="{{ old('escala_trabalho6') }}" placeholder="Escala de Trabalho (Outra:)" /> 
							@endif
						 </td> 
					 ...
					 <center>		
					  <table class="table table-bordered" style="height: 10px;">
						...
						<tr id="linha1">
						 ...
						 <td><font size="2"><b> Período: </b></font><br> 
						   <input class="form-control form-control-sm" type="date" style="width: 130px;" id="mes_ano" name="mes_ano" required onchange="handler(event);" value="{{ old('mes_ano') }}" />
						 </td>
						 <td> <b><font size="2">Até:</b></font>
						 ...
						 <td><b><font size="2">Valor a ser Pago:</font></b>
						   <input class="form-control form-control-sm" title="(Quantidade * Valor)" readonly step="00.01" placeholder="2500 / 2580,21" step="00.01" type="number" id="valor_pago_plantao" name="valor_pago_plantao" value="{{ old('valor_pago_plantao') }}" />
						 </td>
						</tr>
						@if(old('val') == "on")
						<tr id="linha2" name="linha2">
						 <td><b><font size="2">Profissional:</font></b> 
						 ...
						 <td><font size="2"><b> Período: </b></font><br> 
							<input class="form-control form-control-sm" type="date" style="width: 130px;" id="mes_ano_2" name="mes_ano_2" required onchange="handler2_1(event);" value="{{ old('mes_ano_2') }}" />
						 </td>
						 <td> <b><font size="2">Até:</b></font>
						 ...
						 <td><b><font size="2">Valor a ser Pago:</font></b>
							<input class="form-control form-control-sm" title="(Quantidade * Valor)" readonly step="00.01" placeholder="2500 / 2580,21" step="00.01" type="number" id="valor_pago_plantao_2" name="valor_pago_plantao_2" value="{{ old('valor_pago_plantao_2') }}" />
						 </td>
						</tr>
						@else
						<tr id="linha2" name="linha2">
						 ...
						 <td><font size="2"><b> Período: </b></font><br> 
							<input disabled class="form-control form-control-sm" type="date" style="width: 130px;" id="mes_ano_2" name="mes_ano_2" required onchange="handler2_1(event);" value="{{ old('mes_ano_2') }}" />
						 </td>
						 <td> <b><font size="2">Até:</b></font>
						...
						<tr id="linha3">
						 ...
						 <td><font size="2"><b> Período: </b></font><br> 
							<input class="form-control form-control-sm" type="date" style="width: 130px;" id="mes_ano_3" name="mes_ano_3" required onchange="handler3(event);" value="{{ old('mes_ano_3') }}" />
						 </td>
						 <td> <b><font size="2">Até:</b></font>
						...
						<tr id="linha3">
						 ...
						 <td><font size="2"><b> Período: </b></font><br> 
							<input disabled class="form-control form-control-sm" type="date" style="width: 130px;" id="mes_ano_3" name="mes_ano_3" required onchange="handler3(event);" value="{{ old('mes_ano_3') }}" />
						 </td>
						 <td> <b><font size="2">Até:</b></font>
