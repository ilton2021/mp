                ...
                <fieldset class="show">
                  ...
                  <form action="{{ \Request::route('validarPDs') }}" method="post">
                    ...
                    <table class="table table-sm table-bordered" style="font-size: 12px;">
                        ...
                        @if($qtdVagas > 0) 
                        <tr><td colspan="9"><br><b><font size="04px">APROVAR INSCRIÇÃO:</font></b></td></tr>
                        <tr>
                    ...
                    <table class="table table-sm" style="height: 10px">
                        <tr>
                            <td align="right"> <a href="{{ route('inscricaoPD') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a>  </td>
                        </tr>
                    </table>
