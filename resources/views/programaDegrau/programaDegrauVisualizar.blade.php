	  ...
	  <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <center>
		   ...
		   <tr>
			...
			<tr>
			  <td colspan="1">Vaga: <input class="form-control" type="text" id="vaga" name="vaga" required="true" value="<?php echo $pd[0]->vaga; ?>" readonly="true" /></td>
			...
			<tr>
			  <td>Departamento: <input class="form-control" type="text" id="area" name="area" value="<?php echo $pd[0]->departamento; ?>" readonly="true" /></td>
			  <td>Data Emissão: <input class="form-control" type="text" id="data_emissao" name="data_emissao" readonly="true" value="<?php echo date('d-m-Y', strtotime($pd[0]->data_emissao)); ?>" /></td>
			  <td>Data Prevista: <input class="form-control" type="text" id="data_prevista" name="data_prevista" readonly="true" required value="<?php echo date('d-m-Y', strtotime($pd[0]->data_prevista)); ?>" /></td>
			</tr>
		   </table>
		  </center> 
		  <?php $a = 0; ?>
		  ...
		  <table class="table table-bordered" style="width: 1000px;" cellspacing="0">
		   <tr>
			...
			<td><textarea type="text" id="descricao" name="descricao" class="form-control" required="true" rows="10" cols="60" value="<?php echo $just_vaga[0]->descricao; ?>" readonly="true"> {{ $just_vaga[0]->descricao }} </textarea></td>
		   </tr>
		  </table>
		  </center>
