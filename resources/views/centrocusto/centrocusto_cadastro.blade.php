...
<div class="container-fluid">
	<div class="row" style="margin-bottom: 25px; margin-top: 25px;">
		<div class="col-md-12 text-center">
			<h5  style="font-size: 18px;">CADASTRO CENTRO DE CUSTO:</h5>
		</div>
	</div>	
	@if ($errors->any())
		...
		<div class="col-md-12">
			...
			<table class="table table-sm " id="my_table">
				...
				<tbody>
					...
					<tr>
						<td style="font-size: 15px;">{{$centrocusto->nome}}</td>
						<td><center><a class="btn btn-info btn-sm" href="{{route('centrocustoAlterar', $centrocusto->id)}}" ><i class="fas fa-edit"></i></center></td>
						<td><center><a class="btn btn-danger btn-sm" href="{{route('centrocustoExcluir', $centrocusto->id)}}" ><i class="fas fa-times-circle"></i></center></td>
					</tr>
					@endforeach
				</tbody>
			</table>
