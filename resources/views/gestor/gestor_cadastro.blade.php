                    ...
                    <div class="form-card">
						...
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						 <table class="table table-sm" style="height: 10px">
						  ...
						  <tr>
							<td colspan="2"><h5 class="sub-heading">CADASTRO DOS GESTORES:</h5></td>
							<td>
						  ...
						  @foreach($gestores as $gestor)
							<tr>
								<td style="width: 450px;" title="<?php echo $gestor->nome; ?>">{{substr($gestor->nome, 0, 40)}}</td>
								<td style="width: 200px;" colspan="2" title="<?php echo $gestor->email; ?>">{{substr($gestor->email, 0, 22)}}</td>
								<td>
								  <center>
									<a class="btn btn-info btn-sm" href="{{route('gestorAlterar', $gestor->id)}}" ><i class="fas fa-edit"></i> </a>
								    <a class="btn btn-danger btn-sm" href="{{route('gestorExcluir', $gestor->id)}}" ><i class="fas fa-times-circle"></i> </a> 
								  </center>
								</td>
							</tr>
							@endforeach
                            <tr>
							  <td colspan="4"> {{ $gestores->appends(['pesq2' => isset($pesq2) ? $pesq2 : '','pesq' => isset($pesq) ? $pesq : ''])->links() }} </td>
							</tr> 
						</table>
                    </div>
                </fieldset> 
