...
<body>
	...
	<center>
	<form action="{{ route('pesquisaVagasAp') }}" method="POST">
    ...
    <table class="table table-bordeared" style="WIDTH: 1000px; border-style:solid; border-color:green;">
		 <tr>
		    <thead>
			  <tr>
			   <td colspan="4"><center><font color="green"><b>VAGAS APROVADAS:</b></font><center></td>
			  </tr>
			  <tr>
			 ...
			 @if(($vaga->solicitante == Auth::user()->name && Auth::user()->funcao != "RH") && ($vaga->concluida == 1 && $vaga->aprovada == 1))
			 <?php $b = 1; ?>
			 <tbody>
			  <tr>  
			 ...
			 @elseif((Auth::user()->id == 30 || Auth::user()->id == 72 || Auth::user()->id == 32 || Auth::user()->id == 23 || Auth::user()->id == 74 || Auth::user()->id == 62) && ($vaga->concluida == 1 && $vaga->aprovada == 1))
			 <?php $b = 1; ?>
			 <tbody>
			  <tr>  
			   <td><center>{{ $vaga->vaga }}</center></td>
			 ...
			 @elseif((($vaga->unidade_id == 3 && Auth::user()->id == 95)  || ($vaga->unidade_id == 7 && Auth::user()->id == 40) || 
					  ...
					  ($vaga->unidade_id == 8 && Auth::user()->id == 73)) && ($vaga->concluida == 1 && $vaga->aprovada == 1))
			 <?php $b = 1; ?>
			 <tbody>
			  <tr>  
			   <td><center>{{ $vaga->vaga }}</center></td>
