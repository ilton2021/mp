            ...
            <div class="card b-0">
                <fieldset class="show">
					...
					<table class="table table-sm">
						...
						<tr>
						    <td colspan="2" height="20px"><h5 class="sub-heading">NOVO USUÁRIO:</h5></td>
						</tr>
						<tr>
						...
						<tr>
							<td align="right">UNIDADES DE VISUALIZAÇÃO:</td>
							<td>
						...
						<tr>
							<td align="right">UNIDADES DE CADASTRO:</td>
							<td>
								<li style="list-style: none;">
						...
						<tr>
							<td align="right" colspan="2"> <a href="{{ route('cadastroUsuario') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-bottom:30px;margin-top: 5px;color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a>
