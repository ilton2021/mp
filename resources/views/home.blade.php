         ...
         <fieldset class="show">
          <div class="form-card">
				  ...
				  <table class="table table-bordered"> 
					 <tr>
					 	@if($a == 0)
						<td><center><strong><br>MP validada com Sucesso!!!</strong></center></td>
						@else
					 ...
					 <tr>
						<td> Exportar PDF:
						 <a class="text-danger" href="{{ route('mpPDF', array($idG, $idMP)) }}" title="Download"><img src="{{asset('img/pdf.png')}}" alt="" width="50"></a>
						</td>
					 </tr>
					</table>
					<table class="table table-bordered" style="height: 10px;">
					 <tr>
						@if($a == 0)
						<td align="right"> <a href="{{ route('indexValida') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a> </td>
						@else
						<td align="right"> <a href="{{ url('/home') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a> </td>
						@endif
					 </tr>
					</table> 
				    </center>
