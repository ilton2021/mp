                        ...
                        <div class="row px-1 radio2-group">
                            <div class="card2-block radio">
							 <a href="{{ route('criadasMPs') }}">
                                ...
                                <p class="sub-desc"><center>MP'S CRIADAS</center></p> 
							 </a>
                            </div>
                            
                            <div class="card2-block radio">
							 <a href="{{ route('aprovadasMPs') }}">
                                <div class="image2-icon">
                                    <img class="icon2 icon1" src="{{asset('img/mpVisualizar.png')}}">
                                </div>
                                <p class="sub-desc"><center>MP'S APROVADAS</center></p>
							 </a>
                            </div>

                            <div class="card2-block radio">
							  <a href="{{ route('reprovadasMPs') }}">
                                <div class="image2-icon">
                                    <img class="icon2 icon1" src="{{asset('img/mpVisualizar.png')}}">
                                </div>
                                <p class="sub-desc"><center>MP'S REPROVADAS</center></p>
                                </a>
                            </div>
