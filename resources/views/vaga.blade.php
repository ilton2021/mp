	  ...
	  <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <center>
		   <table class="table table-bordered" style="width: 1000px;" cellspacing="0"> 
			<tr>
			  ...
			  <?php } else { ?>
			  <td colspan="2"><center><strong><h3><br>Solicitação de Abertura de Vaga - NÃO ORDINÁRIO</h3></strong></center></td>
			  <?php } ?>
		  ...
		  <table class="table table-bordered" style="width: 1000px;" cellspacing="0">
		   <tr>
			...
			<td><textarea type="text" id="justificativa" name="justificativa" class="form-control" required="true" rows="10" cols="60">{{ Request::old('justificativa') }}</textarea></td>
		   </tr>
		  </table>
		  </center>
