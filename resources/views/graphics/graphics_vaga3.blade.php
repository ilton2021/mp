<html>
	...
	<script type="text/javascript">
      ...
      function drawChart2() {
        var data = google.visualization.arrayToDataTable([
		 ...
		 ["Total Salário", <?php echo $totalSA ?>, "green"],
		 ["", <?php echo 0 ?>, "blue"]
		 ]);
  ...
  <body>
	...
	<p align="right"><a href="{{ url('/homeVaga/graphicsVagaIndex') }}" class="btn btn-warning btn-sm" style="margin-top: -15px; color: #FFFFFF;"> Voltar <i class="fas fa-undo-alt"></i> </a></p>
		...
		<center>
	    <form action="{{\Request::route('pesquisarGrafico10')}}" method="post">
		...
		<table>
		 ...
		 <tr>
		   <td colspan="5"><br><center><b>Total de MP's: {{ $qtd }}</b></center></td>
		 </tr>
		</table>
		</form>
		</center>
