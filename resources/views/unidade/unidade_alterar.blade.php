					...
					<form action="{{\Request::route('updateUnidade')}}" method="post" enctype="multipart/form-data">
					 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        ...
                        <tr>
						 ...
						 <tr>
							<td colspan="2"><h5 class="sub-heading">ALTERAR UNIDADE:</h5></td>
						 </tr>
						 <tr>
							<td align="right"> NOME: </td>
							<td>
							  <input class="form-control" style="width: 400px" type="text" id="nome" name="nome" required value="<?php echo $unidade[0]->nome; ?>" />
							</td>
						 </tr>
						 <tr>
                         ...
                         <tr>
						   <td align="right" colspan="2"> <a href="{{ route('cadastroUnidade') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a>
						        <input type="submit" class="btn btn-success btn-sm" style="margin-top: 10px;" value="SALVAR" id="Salvar" name="Salvar" /> </td>
						 </tr>
						</table>
						<table>
						 <tr>
						   <td> <input hidden type="text" id="acao" name="acao" value="alterar_unidade" class="form-control" /> </td>
