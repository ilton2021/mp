                ...
                <fieldset class="show">
                    ...
                    <table class="table table-sm">
                     <tr>
                      <td align="center">
                       <br>TOTAL:<br>
                        <a type="button" href="{{ route('graphicsVaga') }}" class="btn btn-success btn-info btn-sm">Gráfico Total de Vagas</a> <br> <br>
                        <a type="button" href="{{ route('graphicsVaga2') }}" class="btn btn-success btn-info btn-sm">Gráfico Total de Vagas Por Unidade</a> <br> <br>
                        <a type="button" href="{{ route('graphicsVaga3') }}" class="btn btn-success btn-info btn-sm">Gráfico Total de Salário das Vagas</a>
                      </td>
                     </tr>
                    </table>
                    <table class="table table-sm" style="height: 10px">
					  <tr>
						<td align="right">
					 	  <a href="{{ route('visualizarVagas') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a>
						</td> 
                      </tr>
                    </table>
                    </center>
