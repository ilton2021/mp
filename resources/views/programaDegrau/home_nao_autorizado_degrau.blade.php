    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-5 col-lg-6 col-md-7">
            <div class="card b-0">
                ...
                <fieldset class="show">
                  <div class="form-card">
                  <form method="POST" action="{{ route('storeNAutPD', $pd[0]->id) }}">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<center>
					<table class="table table-bordered" style="height: 10px;"> 
						<tr>
						<td width="800"><center><strong><br>Não Autorizar Vaga!!! </strong></center></td>
					...
					<tr> 
						<td>Justificativa:</td>
						<td><textarea id="motivo" name="motivo" required class="form-control" rows="4"></textarea></td>
					</tr>
					<tr>
						<td><b>VOLTAR VAGA PARA O SOLICITANTE:</b></td>
						<td> <input type="checkbox" id="voltarVaga" name="voltarVaga" /></td>
					</tr>
					<tr>
					<td colspan="2"> Marque o checkbox para voltar esta Vaga ao Solicitante. <br>
						Para <b>Não Autorizar</b> esta <b>Vaga</b> <b> não marque o checkbox. </b>
					</td>
					</tr>
					</table>
					</center>	
