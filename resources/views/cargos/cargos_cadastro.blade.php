    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-5 col-lg-6 col-md-7">
            <div class="card b-0">
                <fieldset class="show">
                    <div class="form-card">
                      	<form method="POST" action="{{ route('pesquisarCargo') }}">	
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						 <table class="table" border="0">
						  ...
						  <tr>
							<td colspan="2"><h5 class="sub-heading">CADASTRO DOS CARGOS:</h5></td>
							<td>
						...
						<tr>
							<td style="font-size: 15px;" colspan="3">{{$cargo->nome}}</td>
							<td>
							  <center>
								<a class="btn btn-info btn-sm" href="{{route('cargoAlterar', $cargo->id)}}" ><i class="fas fa-edit"></i></a>
							    <a class="btn btn-danger btn-sm" href="{{route('cargoExcluir', $cargo->id)}}" ><i class="fas fa-times-circle"></i></a>
							  </center>
							</td>
						</tr>
						@endforeach
