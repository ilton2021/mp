                ...
                <fieldset class="show">
                  ...
                  <form action="{{ \Request::route('validarPDs') }}" method="post">
                    ...
                    <table class="table table-sm table-bordered" style="font-size: 12px;">
                        <?php $qtdVagas = sizeof($vagas); ?>
                        @if($qtdVagas > 0) 
                        <tr><td colspan="9"><br><b><font size="04px">VAGAS:</font></b></td></tr>
                        <tr>
                        <td><center>SELECIONAR <br><input onclick="habilitar('sim')" type="checkbox" id="checkAll1" name="checkAll1" /></center> </td>
                            ...
                            @if($aprovacao[$ap]->vaga_interna_id == $vaga->id)
                    ...
                    <center>
                    <table class="table table-sm table-bordered" style="height: 10px;"> 
                     <tr>
