                ...
                <fieldset class="show">
                    <div class="form-card">
                        ...
                        <div class="row px-1 radio2-group">
                          <div class="card2-block radio">
							 <a href="{{ route('index3') }}">
                                <div class="image3-icon">
                                    <img class="icon3 icon1" src="{{asset('img/mp.png')}}">
                                </div>
                                <p class="sub-desc"><center>NOVA VAGA PD</center></p> 
							 </a>
                          </div>
                          ...
                          <div class="card2-block radio">
						    <a href="{{ route('inscricaoPD') }}">
                             <div class="image3-icon"> 
                               <img class="icon3 icon1" src="{{asset('img/mpVisualizar.png')}}">
                             </div>
                             <p class="sub-desc"><center>INSCRIÇÃO VAGA</center></p>
						    </a>
                          </div>
                          @break
                          @endif
                          ...
                          <div class="card2-block radio">
							 <a href="{{ route('visualizarVagasPD') }}">
                                <div class="image3-icon">
                                    <img class="icon3 icon1" src="{{asset('img/mpVisualizar.png')}}">
                                </div>
                                <p class="sub-desc"><center>VISUALIZAR VAGA</center></p> 
							 </a>
                          </div>
                    ...
                    <div class="col align-self-start"> <br>
                        <a href="{{ url('/duvidasPD') }}" class="btn btn-success btn btn-sm" style="color: #FFFFFF;"> DÚVIDAS </a>
