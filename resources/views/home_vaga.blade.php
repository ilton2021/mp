...
<head>
  ...
  <title>Movimentação de Pessoal - Vaga</title>
	      ...
	      <center>
		   <table class="table table-bordered" style="width: 1000px;" cellspacing="0"> 
			...
			<tr>
			  <td>
			   Exportar PDF:
			   <a class="text-danger" href="{{ route('vagaPDF', array($idG, $idVaga)) }}" title="Download PDF Vaga"><img src="{{asset('img/pdf.png')}}" alt="" width="60"></a>
			  </td>
			</tr>
		   </table>
		  </center>		  		  
