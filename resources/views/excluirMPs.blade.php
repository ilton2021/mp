            ...
            <div class="card b-0">
                ...
                <fieldset class="show">
					...
					<tr>
						...
						<td> <input type="submit" class="btn btn-success btn-sm btn-sm" style="margin-top: 10px;" value="PESQUISAR" id="Salvar" name="Salvar" /> </td>
					</tr>
					</table>
					</form>
					...
					<tr>
						<thead>
						<tr>
						<td colspan="6"><center><font color="red"><b>MP'S:</b></font><center></td>
						</tr>
						<tr>
						...
						<td title="<?php echo $mp->solicitante; ?>"><center>{{ substr($mp->solicitante, 0, 20) }}</center></td>   
						@if(Auth::user()->id == 71) 
						<td><center><a href="{{ route('excluirMP', $mp->id) }}" class="btn-danger btn btn-sm">EXCLUIR</center></a></td>
						@endif
						<td><center><a href="{{ route('inativarMPs', $mp->id) }}" class="btn-info btn btn-sm">INATIVAR</center></a></td>
					...
					<table  style="margin-top: -10px" border="0">
						...
						<td> <a href="{{url('homeMP')}}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="color: #FFFFFF; margin-top: -10px"> VOLTAR <i class="fas fa-undo-alt"></i> </a> </td>
					  </tr> 
					</table>
                    </div>
                </fieldset> 
