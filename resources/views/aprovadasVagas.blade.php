...
<body>
    ...
    <table class="table table-bordeared" style="WIDTH: 1200px; border-style:solid; border-color:green;">
		 <tr>
		    <thead>
			  <tr>
			   <td colspan="5"><center><font color="green"><b>VAGAS APROVADAS:</b></font><center></td>
			  </tr>
			  <tr>
