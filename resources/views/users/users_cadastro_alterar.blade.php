            ...
            <div class="card b-0">
                ...
                <fieldset class="show">
					...
					<table class="table table-sm">
						...
						<tr>
						    <td colspan="2" height="20px"><h5 class="sub-heading">ALTERAR USUÁRIO:</h5></td>
						</tr>
						<tr>
						...
						<tr>
						  <td align="right" colspan="2"> <br> <a href="{{ route('cadastroUsuario') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a>
