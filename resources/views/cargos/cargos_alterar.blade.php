    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-5 col-lg-6 col-md-7">
            <div class="card b-0">
                <fieldset class="show">
                    <div class="form-card">
					<form action="{{\Request::route('updateCargo', $cargos[0]->id)}}" method="post">
					 <input type="hidden" name="_token" value="{{ csrf_token() }}">
						<table class="table table-bordered">
						 ...
						 <tr>
						    <td colspan="2" height="20px"><h5 >ALTERAR CARGO:</h5></td>
						 </tr>
						 <tr>
							<td> Nome: </td>
							<td>
								<input class="form-control" style="width: 400px" type="text" id="nome" name="nome" required value="<?php echo $cargos[0]->nome; ?>" />
							</td>
						 </tr>
						 <tr>
						  <td colspan="2" align="right"> <a href="{{ route('cadastroCargo') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a>
						       <input type="submit" class="btn btn-success btn-sm" style="margin-top: 10px;" value="SALVAR" id="Salvar" name="Salvar" /> </td>
						 </tr>
						</table>
						 <tr>
							<td> <input hidden type="text" id="acao" name="acao" value="alterar_cargo" class="form-control" /> </td>
